...
function App() {
  ...
  return (
    <S.HomeContainer>
      <SocialMediaIconsReact borderColor="rgba(0,0,0,0)" borderWidth="5" borderStyle="solid" icon="github" 
      iconColor="rgba(255,255,255,1)" backgroundColor="rgba(28,28,28,1)" iconSize="5" roundness="50%" url="" size="80" />
